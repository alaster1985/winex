    ...
    <div class="row">
        <div class="navbar-header__wr col-sm-12">
            <div class="site-nav__img-wrapper">
                <a class="site-nav__img-link" href="/"><img class="site-nav__img" src={{asset('images/main_logo.png')}} alt="Logo"></a>
            </div>
            <div class="navbar-header">
                <button type="button" class="site-nav__btn navbar-toggle fa fa-bars" data-toggle="collapse" data-target=".navbar-collapse">
                </button>
            </div>
            ...
            <div class="site-nav__collapse navbar-collapse navbar-collapse collapse">
                <ul class="site-nav__list">
                    <li class="site-nav__item">
                        <a href="/" @if(Route::currentRouteName() === 'index') class="site-nav__link site-nav__link--current" @else class="site-nav__link" @endif>Wine Market</a>
                    </li>
                    <li class="site-nav__item">
                        <a href="cave" @if(Route::currentRouteName() === 'cave') class="site-nav__link site-nav__link--current" @else class="site-nav__link" @endif>My Cave</a>
                    </li>
                    <li class="site-nav__item">
                ...
                <div class="user-nav__menu-wrapper clearfix">
                    <a class="user-nav__link user-nav__link-userName">Mickey Mouse</a>
                    <a class="user-nav__link user-nav__logout" href="#"><i class="fa fa-user user-nav__logout-icon" aria-hidden="true"></i>Logout</a>
                    <div class="user-nav__menu-btn"><span class="user-nav__menu-btn-text">Setting</span><i class="user-nav__menu-btn-icon fa fa-cog"></i></div>
                </div>
            </div>
        </div>
